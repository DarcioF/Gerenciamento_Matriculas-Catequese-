      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-cross"></i>   Relatório Aluno</h1>
          </div>
    ...
    if ($result) {      
        while($row = $result->fetch(PDO::FETCH_OBJ)){
          ...
          echo  '<td>'.$row -> nome . '</td>'. 
              ...
              <td> <a href="form_up_aluno.php?id='.
               $row -> idAluno.'"><i class=" far fa-edit"></i></a>'.'</td>
              <td><a value="id'.
               $row -> idAluno.'"><a href="deletar_aluno.php?id='.$row -> idAluno.'"><button class="dropdown-item" onclick=" return confirm('."'Deseja deletar o registo?'".')"><i class="fa fa-times"></i></button></a></td>';
        echo '</tr>';
        }
      }
      $conn = null;
