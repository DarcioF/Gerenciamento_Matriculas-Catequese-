      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class=" far fa-user"></i>   Cadastro de Usuários</h1>
          </div>
           <?php         
                  if(isset($_GET['res'])){
                    $s = $_GET['res'];
               ...
               ?>
           <form method="POST" action="salvar_usu.php">
            <div class="form-row">
             ...
             <div class="form-group col-md-6">
               ...
               <input type="password" class="form-control"  name="senhaCon" placeholder="Confirmar a Senha" required>
               <?php         
                  if(isset($_GET['res23'])){
                    $s = $_GET['res23'];
                    if ($s=='error') {
