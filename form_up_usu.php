<?php
  ...
  $result = $conn -> query("SELECT * FROM login WHERE idUsu = '{$id}'");
  if ($result){
    $row = $result->fetch();
    $codLog = $row["codLog"];
    $nome = $row["nome"];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class=" far fa-user"></i>   Alterar Usuários</h1>
          </div>
           <?php         
                  if(isset($_GET['res'])){
                    $s = $_GET['res'];
               ...
               ?>
           <form  method="POST" action="alterar_usu.php">
            <div class="form-row">
             <div class="form-group col-md-6">
               <label for="inputEmail4">Nome</label>
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input type="hidden" name="codLog" value="<?php echo $codLog; ?>">
               <input type="text" class="form-control" name="nome" value="<?php echo  $nome ?>" id="inputEmail4" placeholder="Nome" required>
                <?php         
                  if(isset($_GET['res22'])){
                    $s = $_GET['res22'];
                    if ($s=='error') {
              ...
              <div class="form-group col-md-6">
               ...
               <input type="password" class="form-control"  name="senha" value="<?php echo $senha ?>" placeholder="Senha" required>
               </div>
             <div class="form-group col-md-6">
               <label for="inputPassword4">Confirmar a Senha</label>
               <input type="password" class="form-control"  name="senhaCon" value="<?php echo $senha ?>" placeholder="Confirmar a Senha" required>
               <?php         
                  if(isset($_GET['res23'])){
                    $s = $_GET['res23'];
                    if ($s=='error') {
