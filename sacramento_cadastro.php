      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-cross"></i>   Cadastro de Sacramento</h1>
          </div>
                <?php         
                  if(isset($_GET['res'])){
                    $s = $_GET['res'];
                    ...
                    echo '<div style="width: 50%; padding: 6px" class="alert alert-danger" role="alert">
                          Error ao cadastra. Digite a Descrição!
                       </div>';
                    }
                  if($s=='sucesso'){
               ...
               ?>
             	...
             	<form method="POST" action="salvar_sacramento.php">
  					<div class="form-row">
   					 <div class="form-group col-md-6">
     					 <label for="inputEmail4">Descrição</label>
     					 <input type="text" class="form-control" name="descricao" id="inputEmail4" placeholder="Nome" required>
               <?php         
                  if(isset($_GET['res22'])){
                    $s = $_GET['res22'];
                    if ($s=='error') {
