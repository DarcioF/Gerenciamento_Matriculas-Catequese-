        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="relatorio_sacramento.php">Sacramento</a>
             <a class="collapse-item" href="Chamadas.php">Gerar Chamadas</a>
              <a class="collapse-item" href="Certificados.php">Gerar Certificados</a>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class="fa fa-file"></i>   Gerador Chamadas</h1>
          </div>
            
              <form method="POST" action="ImprimirChamada.php" target="_blank">
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                 <label for="inputEstado">Selecione a Catequista</label>
                <select id="idSacramento" name="idCatequista" class="form-control" required>
            ...
            <div class="form-group">
              <input value="Imprimir" type="submit" class="btn btn-primary"></input>
             </div>
            </div>
          </form>
