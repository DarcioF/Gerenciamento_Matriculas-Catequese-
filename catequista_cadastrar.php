      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-chalkboard-teacher"></i>   Cadastro de Catequista</h1>
          </div>
               <?php         
                  if(isset($_GET['res'])){
                    $s = $_GET['res'];
                    ...
                    echo '<div style="width: 50%; padding: 6px" class="alert alert-danger" role="alert">
                          Error ao cadastra. Selecione um Sacramento!
                       </div>';
                    }
                  if($s=='sucesso'){
               ...
               ?>
             <form  method="POST" action="salvar_catequista.php">
            <div class="form-row">
             <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
               ...
               <input maxlength="14" type="text" class="form-control" onkeypress="mascara2(this)" id="cpf" name="cpf" placeholder="Cpf" required>
                <?php         
                  if(isset($_GET['res22'])){
                    $s = $_GET['res22'];
                    if ($s=='error') {
           ...
           <div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input maxlength="15" type="text" class="form-control" onkeypress="mascara(this)" name="telefone" placeholder="Telefone">
                              </div>
              <div class="form-group col-md-4">
