<?php
	...
	$result = $conn -> query("SELECT * FROM catequista INNER JOIN sacramento ON catequista.idCatequista ='{$id} ' AND sacramento.idSacramento='{$idSacramento}'");
	if ($result){
		$row = $result->fetch();
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-chalkboard-teacher"></i>   Alterar Catequista</h1>
          </div>
               <?php         
                  if(isset($_GET['res'])){
                    $s = $_GET['res'];
               ...
               ?>
             <form  method="POST" action="alterar_catequista.php">
            <div class="form-row">
             <div class="form-group col-md-6">
               <label for="inputEmail4">Nome</label>
                <input type="hidden" name="cpfVerif" value="<?php echo   $cpf; ?>">
               <input type="hidden" name="idCatequista" value="<?php echo $idCatequista; ?>">
               <input type="text" value="<?php echo $nomeC; ?>" class="form-control" name="nome" id="inputEmail4" placeholder="Nome" required>
              </div>
              <div class="form-group col-md-6">
               <label for="inputPassword4">Cpf</label>
               <input type="text" value="<?php echo $cpf; ?>"   onkeypress="mascara2(this)" class="form-control" maxlength="14"  name="cpf" placeholder="Cpf" required>
               <?php         
                  if(isset($_GET['res22'])){
                    $s = $_GET['res22'];
                    if ($s=='error') {
           ...
           <div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" value="<?php echo $telefone; ?>"  onkeypress="mascara(this)"  class="form-control" maxlength="15" name="telefone" placeholder="Telefone">
              </div>
              <div class="form-group col-md-4">
                <label for="inputEstado">Sacramento</label>
                <select id="Curso" name="idSacramento" class="form-control" required>
                <?php require_once './model/conexao.php';
                     echo '<option style="color: black; " value="'.$idSacramento.'">'.$descricao.'</option>';
